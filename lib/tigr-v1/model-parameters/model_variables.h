...
const char* ei_classifier_inferencing_categories[] = { "tiger" };
...
const ei_impulse_t impulse_574760_0 = {
    .project_id = 574760,
    .project_owner = "Bonifacy Klocek",
    .project_name = "tigr",
    .impulse_id = 1,
    .impulse_name = "Impulse #1",
    .deploy_version = 1,

    .nn_input_frame_size = 6400,
    ...
    .visual_ad_grid_size_x = int((80 / 8) / 2 - 1),
    .visual_ad_grid_size_y = int((80 / 8) / 2 - 1),
    
    .tflite_output_features_count = 200,
...
ei_impulse_handle_t impulse_handle_574760_0 = ei_impulse_handle_t( &impulse_574760_0 );
ei_impulse_handle_t& ei_default_impulse = impulse_handle_574760_0;
